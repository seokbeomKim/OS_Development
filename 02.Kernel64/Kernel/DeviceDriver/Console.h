...
#define CONSOLE_DEFAULT_TEXT_COLOR			(CONSOLE_BACKGROUND_BLACK | CONSOLE_FOREGROUND_BRIGHTGREEN)

#define CONSOLE_WIDTH				80
#define CONSOLE_HEIGHT				25
#define CONSOLE_VIDEOMEMORYADDR		0XB8000

// I/O Port Address of Video Controller
...
{
	int iCurrentPrintOffset;	// Ãâ·Â OFFSET
} CONSOLEMANAGER;
#pragma pack (pop)
